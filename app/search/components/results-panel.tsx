...
import { sourcesToBibtex, sourcesToRis, downloadFile } from "@/lib/citation-export"
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="gap-2"
                onClick={() => {
                  const content = sourcesToBibtex(result.sources)
                  downloadFile(content, "synapse-references.bib", "application/x-bibtex")
                }}
              >
              ...
              <Button
                ...
                className="gap-2"
                onClick={() => {
                  const content = sourcesToRis(result.sources)
                  downloadFile(content, "synapse-references.ris", "application/x-research-info-systems")
                }}
              >
